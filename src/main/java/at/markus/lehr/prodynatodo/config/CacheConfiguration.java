package at.markus.lehr.prodynatodo.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, at.markus.lehr.prodynatodo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, at.markus.lehr.prodynatodo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
